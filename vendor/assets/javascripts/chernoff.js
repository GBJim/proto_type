...
function d3_chernoff() {
    ...
    function __chernoff(d) {
        ...
        var leye = [{x: 60, y: 90-eyehvar}, {x: 55+eyewvar, y: 90},
        ...
        ele.selectAll("path.leye").data([leye]).enter()
            ...
            .attr("class", "leye")
            .attr("d", bline);
        ele.append("circle").attr("r",1).attr("transform","translate(55,90)").style("fill","black");

        ele.selectAll("path.reye").data([reye]).enter()
            .append("path")
            .attr("class", "reye")
            .attr("d", bline);
        ele.append("circle").attr("r",1).attr("transform","translate(86,90)").style("fill","black");
